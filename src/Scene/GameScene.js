...
class GameScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.spritesheet(
      "warp",
      "assets/sprites/Green Portal Sprite Sheet.png",
      {
        frameWidth: 64,
        frameHeight: 64,
      }
    ...
    this.load.spritesheet(
      "key",
      "assets/Collectables/Dungeon Collectables.png",
      {
        frameWidth: 16,
        frameHeight: 15.5,
      }
  ...
  create() {
    ...
    //floor
    this.floor = this.add
      .tileSprite(0, 680, 2560, 150, "floor5")
      .setScale(0.5)
      .setOrigin(0, 0);
    ...
    this.platform_w1_1 = this.add
      .tileSprite(120, 570, 201, 67, "platform")
      .setOrigin(0, 0)
      .setScale(0.4);
    this.platform_w1_2 = this.add
      .tileSprite(50, 500, 201, 67, "platform")
      .setOrigin(0, 0)
      .setScale(0.4);
    this.platform_w1_3 = this.add
      .tileSprite(200, 400, 134, 67, "platform")
      .setOrigin(0, 0)
      .setScale(0.4);
    this.platform_w1_4 = this.add
      .tileSprite(120, 280, 67, 268, "platform")
      .setOrigin(0, 0)
      .setScale(0.4);
    this.platform_w1_5 = this.add
      .tileSprite(120, 280, 134, 67, "platform")
      .setOrigin(0, 0)
      .setScale(0.4);
    this.platform_w1_6 = this.add
      .tileSprite(13, 280, 268, 67, "platform")
      .setOrigin(0, 0)
      .setScale(0.4);
    this.platform_w1_7 = this.add
      .tileSprite(10, 200, 134, 67, "platform")
      .setOrigin(0, 0)
      .setScale(0.4);
    this.platform_w1_8 = this.add
      .tileSprite(150, 150, 134, 67, "platform")
      .setOrigin(0, 0)
      .setScale(0.4);

    //platform-wall2
    this.platforms_w2 = this.physics.add.staticGroup();
    this.platform_w2_1 = this.add
      .tileSprite(324, 120, 335, 67, "platform")
      .setOrigin(0, 0)
      .setScale(0.4);
    this.platform_w2_2 = this.add
      .tileSprite(522, 120, 134, 67, "platform")
      .setOrigin(0, 0)
      .setScale(0.4);
    this.platform_w2_3 = this.add
      .tileSprite(415, 180, 268, 67, "platform")
      .setOrigin(0, 0)
      .setScale(0.4);
    this.platform_w2_4 = this.add
      .tileSprite(324, 250, 268, 67, "platform")
      .setOrigin(0, 0)
      .setScale(0.4);
    this.platform_w2_5 = this.add
      .tileSprite(469, 250, 134, 67, "platform")
      .setOrigin(0, 0)
      .setScale(0.4);
    this.platform_w2_6 = this.add
      .tileSprite(390, 310, 335, 67, "platform")
      .setOrigin(0, 0)
      .setScale(0.4);
    this.platform_w2_7 = this.add
      .tileSprite(324, 370, 201, 67, "platform")
      .setOrigin(0, 0)
      .setScale(0.4);
    this.platform_w2_8 = this.add
      .tileSprite(522, 146, 67, 536, "platform")
      .setOrigin(0, 0)
      .setScale(0.4);
    this.platform_w2_9 = this.add
      .tileSprite(450, 337, 67, 670, "platform")
      .setOrigin(0, 0)
      .setScale(0.4);
    this.platform_w2_10 = this.add
      .tileSprite(324, 495, 134, 67, "platform")
      .setOrigin(0, 0)
      .setScale(0.4);
    this.platform_w2_11 = this.add
      .tileSprite(324, 620, 201, 67, "platform")
      .setOrigin(0, 0)
      .setScale(0.4);
    this.platform_w2_12 = this.add
      .tileSprite(397, 430, 134, 67, "platform")
      .setOrigin(0, 0)
      .setScale(0.4);
    this.platform_w2_13 = this.add
      .tileSprite(370, 555, 201, 67, "platform")
      .setOrigin(0, 0)
      .setScale(0.4);
    this.platform_w2_14 = this.add
      .tileSprite(515, 563, 67, 268, "platform")
      .setOrigin(0, 0)
      .setScale(0.4);
    this.platform_w2_15 = this.add
      .tileSprite(476, 471, 67, 67, "platform")
      .setOrigin(0, 0)
      .setScale(0.4);

    //platform-wall3
    this.platforms_w3 = this.physics.add.staticGroup();
    this.platform_w3_1 = this.add
      .tileSprite(720, 579, 268, 67, "platform")
      .setOrigin(0, 0)
      .setScale(0.4);
    this.platform_w3_2 = this.add
      .tileSprite(800, 472, 67, 268, "platform")
      .setOrigin(0, 0)
      .setScale(0.4);
    this.platform_w3_3 = this.add
      .tileSprite(747, 472, 134, 67, "platform")
      .setOrigin(0, 0)
      .setScale(0.4);
    this.platform_w3_4 = this.add
      .tileSprite(700, 390, 134, 67, "platform")
      .setOrigin(0, 0)
      .setScale(0.4);
    this.platform_w3_5 = this.add
      .tileSprite(650, 300, 67, 67, "platform")
      .setOrigin(0, 0)
      .setScale(0.4);
    this.platform_w3_6 = this.add
      .tileSprite(750, 260, 201, 67, "platform")
      .setOrigin(0, 0)
      .setScale(0.4);
    this.platform_w3_7 = this.add
      .tileSprite(650, 170, 67, 67, "platform")
      .setOrigin(0, 0)
      .setScale(0.4);
    this.platform_w3_8 = this.add
      .tileSprite(849, 120, 67, 67, "platform")
      .setOrigin(0, 0)
      .setScale(0.4);

    //platform-wall4
    this.platforms_w4 = this.physics.add.staticGroup();
    this.platform_w4_1 = this.add
      .tileSprite(924, 120, 134, 67, "platform")
      .setOrigin(0, 0)
      .setScale(0.4);
    this.platform_w4_2 = this.add
      .tileSprite(924, 252, 603, 67, "platform")
      .setOrigin(0, 0)
      .setScale(0.4);
    this.platform_w4_3 = this.add
      .tileSprite(1025, 120, 536, 67, "platform")
      .setOrigin(0, 0)
      .setScale(0.4);
    this.platform_w4_4 = this.add
      .tileSprite(1226, 250, 134, 67, "platform")
      .setOrigin(0, 0)
      .setScale(0.4);
    this.platform_w4_5 = this.add
      .tileSprite(1100, 146, 67, 268, "platform")
      .setOrigin(0, 0)
      .setScale(0.4);
    this.platform_w4_6 = this.add
      .tileSprite(975, 350, 670, 67, "platform")
      .setOrigin(0, 0)
      .setScale(0.4);
    this.platform_w4_7 = this.add
      .tileSprite(924, 455, 603, 67, "platform")
      .setOrigin(0, 0)
      .setScale(0.4);
    this.platform_w4_8 = this.add
      .tileSprite(1216, 376, 67, 268, "platform")
      .setOrigin(0, 0)
      .setScale(0.4);
    this.platform_w4_9 = this.add
      .tileSprite(960, 520, 804, 67, "platform")
      .setOrigin(0, 0)
      .setScale(0.4);
    this.platform_w4_10 = this.add
      .tileSprite(953, 628, 67, 67, "platform")
      .setOrigin(0, 0)
      .setScale(0.4);
    this.platform_w4_11 = this.add
      .tileSprite(980, 574, 67, 268, "platform")
      .setOrigin(0, 0)
      .setScale(0.4);
    this.platform_w4_12 = this.add
      .tileSprite(1040.5, 546, 67, 268, "platform")
      .setOrigin(0, 0)
      .setScale(0.4);
    this.platform_w4_13 = this.add
      .tileSprite(1150, 574, 67, 268, "platform")
      .setOrigin(0, 0)
      .setScale(0.4);
    this.platform_w4_14 = this.add
      .tileSprite(1095, 615, 67, 67, "platform")
      .setOrigin(0, 0)
      .setScale(0.4);
    this.platform_w4_15 = this.add
      .tileSprite(950, 180, 67, 67, "platform")
      .setOrigin(0, 0)
      .setScale(0.4);
    ...
    this.spikes
      .create(550, 480, "spike-left")
      .setOrigin(0, 0)
      .setScale(2)
      .setSize(25, 15)
      .setOffset(7, 15);
    this.spikes
      .create(127, 149, "spike-left")
      .setOrigin(0, 0)
      .setScale(1.8)
      .setSize(25, 15)
      .setOffset(7, 15);
    this.spikes
      .create(97, 358, "spike-left")
      .setOrigin(0, 0)
      .setScale(1.8)
      .setSize(25, 15)
      .setOffset(7, 15);
    this.spikes
      .create(826, 119, "spike-left")
      .setOrigin(0, 0)
      .setScale(1.8)
      .setSize(25, 15)
      .setOffset(7, 15);
    this.spikes
      .create(1193, 378, "spike-left")
      .setOrigin(0, 0)
      .setScale(1.8)
      .setSize(25, 15)
      .setOffset(7, 15);
    ...
    this.spikes
      .create(325, 221, "spike-up")
      .setOrigin(0, 0)
      .setScale(1.8)
      .setSize(15, 25)
      .setOffset(17, 15);
    this.spikes
      .create(350, 91, "spike-up")
      .setOrigin(0, 0)
      .setScale(1.8)
      .setSize(15, 25)
      .setOffset(17, 15);
    this.spikes
      .create(1120, 651, "spike-up")
      .setOrigin(0, 0)
      .setScale(1.8)
      .setSize(15, 25)
      .setOffset(17, 15);
    this.spikes
      .create(1110, 426, "spike-up")
      .setOrigin(0, 0)
      .setScale(1.8)
      .setSize(15, 25)
      .setOffset(17, 15);
    this.spikes
      .create(973, 223, "spike-up")
      .setOrigin(0, 0)
      .setScale(1.8)
      .setSize(15, 25)
      .setOffset(17, 15);
    this.spikes
      .create(1000, 223, "spike-up")
      .setOrigin(0, 0)
      .setScale(1.8)
      .setSize(15, 25)
      .setOffset(17, 15);
    this.spikes
      .create(1130, 223, "spike-up")
      .setOrigin(0, 0)
      .setScale(1.8)
      .setSize(15, 25)
      .setOffset(17, 15);
    this.spikes
      .create(325, 466, "spike-up")
      .setOrigin(0, 0)
      .setScale(1.8)
      .setSize(15, 25)
      .setOffset(17, 15);
    this.spikes
      .create(952.2, 599, "spike-up")
      .setOrigin(0, 0)
      .setScale(1.8)
      .setSize(15, 25)
      .setOffset(17, 15);
    this.spikes
      .create(1000, 321, "spike-up")
      .setOrigin(0, 0)
      .setScale(1.8)
      .setSize(15, 25)
      .setOffset(17, 15);
    this.spikes
      .create(1110, 321, "spike-up")
      .setOrigin(0, 0)
      .setScale(1.8)
      .setSize(15, 25)
      .setOffset(17, 15);
    this.spikes
      .create(1214, 321, "spike-up")
      .setOrigin(0, 0)
      .setScale(1.8)
      .setSize(15, 25)
      .setOffset(17, 15);
    this.spikes
      .create(801, 231, "spike-up")
      .setOrigin(0, 0)
      .setScale(1.8)
      .setSize(15, 25)
      .setOffset(17, 15);
    ...
    this.spikes
      .create(747, 499, "spike-down")
      .setOrigin(0, 0)
      .setScale(1.8)
      .setSize(15, 25)
      .setOffset(16, 8);
    this.spikes
      .create(1250, 276, "spike-down")
      .setOrigin(0, 0)
      .setScale(1.8)
      .setSize(15, 25)
      .setOffset(16, 8);
    this.spikes
      .create(1010, 377, "spike-down")
      .setOrigin(0, 0)
      .setScale(1.8)
      .setSize(15, 25)
      .setOffset(16, 8);
    this.spikes
      .create(420, 456, "spike-down")
      .setOrigin(0, 0)
      .setScale(1.8)
      .setSize(15, 25)
      .setOffset(16, 8);
    ...
    this.spikes
      .create(827, 550, "spike-right")
      .setOrigin(0, 0)
      .setScale(1.8)
      .setSize(25, 15)
      .setOffset(7, 15);
    this.spikes
      .create(624, 450, "spike-right")
      .setOrigin(0, 0)
      .setScale(1.8)
      .setSize(25, 15)
      .setOffset(7, 15);
    this.spikes
      .create(324, 330, "spike-right")
      .setOrigin(0, 0)
      .setScale(1.8)
      .setSize(25, 15)
      .setOffset(7, 15);
    this.spikes
      .create(924, 280, "spike-right")
      .setOrigin(0, 0)
      .setScale(1.8)
      .setSize(25, 15)
      .setOffset(7, 15);
    this.spikes
      .create(624, 245, "spike-right")
      .setOrigin(0, 0)
      .setScale(1.8)
      .setSize(25, 15)
      .setOffset(7, 15);
    this.spikes
      .create(624, 119, "spike-right")
      .setOrigin(0, 0)
      .setScale(1.8)
      .setSize(25, 15)
      .setOffset(7, 15);
